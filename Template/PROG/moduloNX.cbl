...
@MOVEKEYS
           ...
           IF @APPLIDW00C-COD-RETORNO OF LNK-@APPLID3@SIGLAPGM@TYPEPGM NOT EQUAL TO ZEROS
              ...
              END-IF
           ELSE
              MOVE 8          TO @APPLIDW00C-COD-RETORNO  OF LNK-@APPLID3@SIGLAPGM@TYPEPGM
              MOVE '@ERRLOCAL2'     TO @APPLIDW00C-COD-ERRO     OF LNK-@APPLID3@SIGLAPGM@TYPEPGM
              MOVE '@MSGERROR' TO @APPLIDW00C-COD-MENSAGEM OF LNK-@APPLID3@SIGLAPGM@TYPEPGM
